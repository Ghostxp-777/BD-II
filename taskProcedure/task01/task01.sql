...
INSERT INTO compra (clienteCPF, funcionarioCPF, valorTotal, dataCompra) VALUES
(12345678901, 65432109876, 274.70, '2025-03-15'),
(23456789012, 65432109876, 129.80, '2025-03-20'),
(34567890123, 65432109876, 189.90, '2025-04-10'),
(45678901234, 65432109876, 64.80, '2025-05-05'),
(56789012345, 65432109876, 154.90, '2025-06-18'),
(12345678901, 65432109876, 299.90, '2025-07-22'),
(23456789012, 65432109876, 44.90, '2025-08-30'),
(34567890123, 65432109876, 104.80, '2025-09-05');

INSERT INTO compraProduto (idProduto, idCompra) VALUES
(1, 1), (3, 1), (5, 1), 
(2, 2), (4, 2),
(1, 3), (6, 3),
(3, 4),
...
BEGIN
    SELECT 
        compra.id AS numero_compra,
        cliente.nome AS cliente,
        funcionario.nome AS atendente,
        COUNT(compraProduto.idProduto) AS total_produtos,
        compra.valorTotal AS total,
        compra.dataCompra AS data
    FROM compra
    JOIN cliente ON compra.clienteCPF = cliente.cpf
    JOIN funcionario ON compra.funcionarioCPF = funcionario.cpf
    JOIN compraProduto ON compra.id = compraProduto.idCompra
    WHERE compra.dataCompra BETWEEN '2025-01-01' AND '2025-09-10'
    GROUP BY compra.id, cliente.nome, funcionario.nome, compra.valorTotal, compra.dataCompra;
END $$
